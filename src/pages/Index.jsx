          ...
          <Box flex="1" bg="gray.100" p={4}>
            <Box flex="1" bg="gray.100" p={4}>
              ...
              <Flex h="20%" alignItems="center" justifyContent="space-between" p={4} borderTopWidth="1px">
                <Button onClick={prevStep} isDisabled={activeStep === 1 || activeStep === maxSteps}>
                  Previous
                </Button>
                {activeStep < maxSteps && <Button onClick={nextStep} isDisabled={activeStep === maxSteps}>Next</Button>}
                {activeStep === maxSteps && (
